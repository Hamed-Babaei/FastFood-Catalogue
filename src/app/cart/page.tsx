...
export default function CartPage() {
  ...
  const calculateTotal = () => {
    return cartItems.reduce(
      (total, item) => total + Number(item.varieties[0].price) * item.count,
      0
    );
  };
  ...
  return (
    <>
      <div className="flex flex-col">
        ...
        <div className="absolute top-[40vh] !w-full max-w-[1400px] !font-iranSans sm:px-8 rounded-md !overflow-hidden">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <p className="text-sm">
                            قیمت:
                            <span>
                              {Number(item.varieties[0].price).toLocaleString(
                                "fa-IR"
                              )}
                            </span>
                            تومان
